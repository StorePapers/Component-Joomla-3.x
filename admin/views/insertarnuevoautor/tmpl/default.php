...
<form name="adminForm" id="adminForm" class="form-validate" method="post">
	<div class="control-group">
		<div class="control-label">	
			<label id="jform_title-lbl" title="" for="jform_title"><?php echo JText::_('NOMBRE_NUEVO_AUTOR');?></label>
		</div>
		<div class="controls">
			<input id="jform_title" class="inputbox required" type="text" MAXLENGTH="250" size="60" value="<?php echo JText::_('NOMBRE_NUEVO_AUTOR');?>" name="nombre" aria-required="true" required="required">
		</div>
	</div>
	<div class="control-group">
		<div class="control-label">	
		...
		<div class="controls">
			<select id="jform_state" class="inputbox" size="1" name="consultable">
				<OPTION VALUE="1" SELECTED><?php echo JText::_('COM_STOREPAPERS_SI');?></OPTION>
				<OPTION VALUE="0"><?php echo JText::_('COM_STOREPAPERS_NO');?></OPTION>
			</select>
		</div>
	</div>
	...
	<input type="hidden" name="view"   		id="view"   value="insertarNuevoAutor" />	
