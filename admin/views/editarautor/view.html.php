...
class StorepapersViewEditarAutor extends JViewLegacy{
	...
	function display($tpl = null){
		...
		//Leo el autor de la BD		
		$data['autor'] = $model->getAutor($_GET['ida']);
	...
	protected function addToolbar() {
		...
		JToolBarHelper::title(JText::_('COM_STOREPAPERS').': '.JText::_('EDITAR_AUTOR'),'storepapers');				
