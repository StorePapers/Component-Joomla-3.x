...
<form name="adminForm" id="adminForm" class="form-validate" method="post">
	<div class="control-group">
		<div class="control-label">	
			<label id="jform_title-lbl" title="" for="jform_title"><?php echo JText::_('ESCRIBIR_AQUI_NUEVO_NOMBRE');?></label>
		</div>
		<div class="controls">
			<input id="jform_title" class="inputbox required" type="text" MAXLENGTH="250" size="60" value="<?php echo $this->data['autor'][0]->nombre;?>" name="nombre" aria-required="true" required="required">
		</div>
	</div>
	<div class="control-group">
		<div class="control-label">	
		...
		<div class="controls">
			<select id="jform_state" class="inputbox" size="1" name="consultable">
				<?php
				if($this->data['autor'][0]->consultable == '1'){
	...
	<input type="hidden" name="view"   		id="view"   value="editarAutor" />	
	<input type="hidden" name="task"   		id="task"   value="display" />
	<input type="hidden" name="id" 			id="id"		value="<?php echo $this->data['autor'][0]->id;?>" />
</form>
