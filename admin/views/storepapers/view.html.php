...
class StorepapersViewStorepapers extends JViewLegacy{
	...
	function display($tpl = null){
		...
		//Compruebo si se puede mostrar el icono de preferencias.
	...
	protected function addToolbar() {
		...
		JToolBarHelper::title(JText::_('COM_STOREPAPERS').': '.JText::_('COM_STOREPAPERS_PANEL_DE_CONTROL'),'storepapers');				
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_storepapers');
