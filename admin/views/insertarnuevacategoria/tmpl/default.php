...
<form name="adminForm" id="adminForm" class="form-validate" method="post">
	<div class="control-group">
		...
		<div class="controls">
			<input id="jform_title" class="inputbox required" type="text" MAXLENGTH="250" size="60" value="<?php echo JText::_('NOMBRE_NUEVA_CATEGORIA');?>" name="nombre" aria-required="true" required="required">
		</div>
	</div>
	<div class="control-group">
		<div class="control-label">	
