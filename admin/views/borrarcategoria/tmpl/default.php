...
<form name="adminForm" id="adminForm" class="form-validate" method="post">
			...
			<td>
				...
				<thead>
					<tr>
						...
						<th><h4><?php echo JText::_('NOMBRE_CATEGORIA_A_BORRAR');?></h4></th>
					</tr>
				</thead>
				<?php
				echo '<tr><td>'.$this->mensaje['categoria'][0]->id.'</td><td>'.JHtml::_('grid.id', 0, $this->mensaje['categoria'][0]->id).'</td><td align="center">'.$this->mensaje['categoria'][0]->nombre.'</td></tr>';
				?>
				</table>
			</td>
		</tr>
			...
			<td>
				...
				<thead>
					<tr>
						...
						<th><h4><?php echo JText::_('NOMBRE_PUBLICACIONES_BORRAN');?></h4></th>
	...
	<input type="hidden" name="view"   		id="view"   value="borrarCategoria" />
	<input type="hidden" name="id" 			id="id"		value="<?php echo $this->mensaje['idc'];?>" />
