...
class StorepapersViewEditarCategoria extends JViewLegacy{
	...
	function display($tpl = null){
		...
		$data['categoria'] = $model->getCategoria($_GET['idc']);
	...
	protected function addToolbar() {
		...
		JToolBarHelper::title(JText::_('COM_STOREPAPERS').': '.JText::_('EDITAR_CATEGORIA'),'storepapers');
